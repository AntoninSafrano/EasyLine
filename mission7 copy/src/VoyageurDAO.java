...
public class VoyageurDAO extends DAO<Voyageur> {
    ...
    public static void main(String[] args) {
        ...
        AdressePostale adressePostale1 = new AdressePostale("Rue du la Paix", "Evry", 93120);
        AdressePostale adressePostale2 = new AdressePostale("Rue du Navet", "Sens", 52000);

        Bagage bagage1 = new Bagage(1, 30, "vert");
        ...
        Voyageur voyageur1 = new Voyageur("Ja", 35, adressePostale1,
                bagage1);
        Voyageur voyageur2 = new Voyageur("Irving", 30, adressePostale2,
                bagage2);
